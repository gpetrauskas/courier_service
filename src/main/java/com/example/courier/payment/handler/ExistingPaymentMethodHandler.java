...
public class ExistingPaymentMethodHandler implements PaymentHandler {
     ...
     *
     * @param paymentRequestDTO incoming payment request containing payment method details
    ...
    /**
     * Fetches payment method by given ID using paymentMethodService
     ...
     *
     * @param paymentRequestDTO the payment request containing payment method ID and payment details
