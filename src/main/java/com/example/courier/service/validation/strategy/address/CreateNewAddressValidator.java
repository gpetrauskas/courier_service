...
@Service
public class CreateNewAddressValidator extends BaseValidator implements AddressValidationStrategy {
    private final AddressValidator addressValidator;
    private final PhoneValidator phoneValidator;
    private final NameValidator nameValidator;

    public CreateNewAddressValidator(AddressValidator addressValidator, PhoneValidator phoneValidator, NameValidator nameValidator) {
    ...
    public void validate(AddressDTO dto, List<ApiResponseDTO> errors) {
        ...
        validateRequiredField(dto.city(), "city", "Invalid city format", addressValidator::isCityValid, errors);
        validateRequiredField(dto.street(), "street", "Invalid street format", addressValidator::isStreetValid, errors);
        validateRequiredField(dto.postCode(), "postCode", "Invalid post code format", addressValidator::isPostalCodeValid, errors);
        validateRequiredField(dto.houseNumber(), "houseNumber", "Invalid house number format", addressValidator::isHouseNumberValid, errors);
