...
import dto.person.rest.in.adapter.gytis.courier.PersonDetailsUpdateRequest;
import exception.gytis.courier.CompositeValidationException;
...
public class AdminJpaEntityPersonCommandServiceTest {
    ...
    *//*
    ...
    class SoftDelete {
        ...
        void softDelete_shouldThrowWhenPersonNotFound() {
            when(lookupService.fetchById(TEST_PERSON_ID)).thenThrow(new ResourceNotFoundException("UserJpaEntity not found"));
