...
import org.springframework.data.domain.PageQuery;
...
public class GetOrdersForTaskAssignmentTest {
    ...
    class SuccessTests {
        ...
        void fetchAll_validPagination() {
            ...
            Page<Order> mockPage = new PageImpl<>(orders, PageQuery.of(1, 2), 10);
            when(orderRepository.findAll(ArgumentMatchers.<Specification<Order>>any(), any(Pageable.class))).thenReturn(mockPage);
