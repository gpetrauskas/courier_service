...
import address.domain.gytis.courier.AddressValidationMode;
...
import exception.gytis.courier.UserAddressMismatchException;
...
public class FetchOrCreateOrderAddressTest {
    ...
    void shouldThrowWhenUserIsNull() {
        ...
        assertEquals("UserJpaEntity cannot be null", response.getMessage());
