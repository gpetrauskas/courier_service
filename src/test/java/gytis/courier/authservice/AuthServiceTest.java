...
public class AuthServiceTest {
    ...
    class SuccessCases {
        ...
        void login_validCredentials_works() {
            ...
            verify(personLookupService).findByUsername(TEST_EMAIL);
    ...
    class FailureCases {
        @Test
        @DisplayName("UserJpaEntity login, wrong password throws exception")
        ...
        @Test
        @DisplayName("UserJpaEntity login - fails when email not found")
        void loginUser_emailNotFound_throwsRuntimeException() {
            when(personLookupService.findByUsername(TEST_EMAIL)).thenReturn(null);
    ...
    private void mockUserLookup() {
        when(personLookupService.findByUsername(TEST_EMAIL)).thenReturn(testUser);
    }
