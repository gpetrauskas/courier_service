...
import payment.domain.gytis.courier.ProviderType;
...
import com.example.courier.payment.method.PaymentMethodCommandService;
...
public class ExistingPaymentMethodHandlerTest {
    ...
    @Mock
    PaymentMethodCommandService paymentMethodService;
    @Mock
