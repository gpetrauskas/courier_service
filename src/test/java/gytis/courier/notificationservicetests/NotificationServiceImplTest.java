...
import notification.domain.gytis.courier.NotificationTargetType;
import com.example.courier.domain.Notification;
import com.example.courier.dto.ApiResponseDTO;
import com.example.courier.dto.PaginatedResponseDTO;
import com.example.courier.dto.mapper.NotificationRequestMapper;
...
public class NotificationServiceImplTest {
    ...
    @Mock
    private NotificationRequestMapper notificationMapper;
    @Mock
    ...
    private Pageable pageable = PageQuery.of(0, 10);
    ...
    class GetNotificationsHistory {
        ...
        void success() {
            ...
            PaginatedResponseDTO<NotificationResponseDTO> responseDTO = notificationService.getHistoryForCurrentUser(pageable);
    ...
    class delete {
        ...
        void success_isAdmin() {
            ...
            ApiResponseDTO responseDTO = notificationService.deleteNotifications(List.of(1L));
    ...
    class GetAllForAdmin {
        ...
        void success() {
            ...
            PaginatedResponseDTO<AdminNotificationResponseDTO> responseDTO =
                    notificationService.getAllForAdmin(PageQuery.of(0, 10));
    ...
    class GetPageContainingNotification {
        ...
        void returnPageContainingNotification_success() {
            ...
            int pageSize = 3;
            Pageable pageRequest = PageQuery.of(notificationIndex / pageSize, pageSize, Sort.by("notification.createdAt").descending());
